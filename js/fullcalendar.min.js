...
! function (t) {
        ...
        function o(i) {
            ...
            return o && t.each(o.split(" "), function (n) {
                ...
                t.each(this.split(","), function (n, i) {
                    var s, h, d, f, g, v, m, y;
                    "title" == i ? (o = o.add(t("<br><br><h2 style='font-size:140%; margin-left:-30px;'>&nbsp;</h2>")), c = !1) : ((s = a[i]) ? (d = function (t) {
    ...
    Fe.guid = 0, Fe.mixin({
        buildGotoAnchorHtml: function (e, n, i) {
            ...
            return t.isPlainObject(e) ? (r = e.date, s = e.type, o = e.forceOff) : r = e, r = Wt.moment(r), a = {
                ...
                type: s || "day"
            }, "string" == typeof n && (i = n, n = null), n = n ? " " + rt(n) : "", i = i || "", !o && this.opt("navLinks") ? "<a" + n + ' >' + i + "</a>" : "<span" + n + ">" + i + "</span>"
        },
    ...
    var vn = xe.extend({
        ...
        wn = Wt.DayGrid = ke.extend(Ie, Be, {
            ...
            /* asAllDaybusinessHours: [ // specify an array instead
                {
    ...
    var Sn = xe.extend({
        ...
        Cn = He.extend({
            ...
            fgSegHtml: function (t, e) {
                ...
                return '<center><a style="text-align:center;" class="' + f.join(" ") + '"' + (u.url ? ' href="' + et(u.url) + '"' : "") + (g ? ' style="' + g + '"' : "") + '><div class="fc-content">' + (n ? '<div class="fc-time" data-start="' + et(r) + '" data-full="' + et(i) + '"><span>' + et(n) + "</span></div>" : "") + (u.title ? '<div class="fc-title">' + et(u.title) + "</div>" : "") + '</div><div class="fc-bg"/>' + (d ? '<div class="fc-resizer fc-end-resizer" />' : "") + "</a></center>"
            },
