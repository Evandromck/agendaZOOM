...
!(function (t) {
          ...
          t.each(o.split(" "), function (n) {
            ...
            t.each(this.split(","), function (n, i) {
              ...
              "title" == i
                ? ((o = o.add(
                    t(
                      "<br><br><h2 style='font-size:140%; margin-left:-30px;'>&nbsp;</h2>"
                    )
                  )),
                  (c = !1))
                : ((s = a[i])
          ...
          this.component.rowEls.each(function (e, s) {
            ...
            n && n.row === e
              ...
              : ((o = l.find(".fc-content-skeleton tbody")),
                ...
                (a = o.position().top)),
              u.css("top", a).find("table").append(i[e].tbodyEl),
              l.append(u),
              r.push(u[0]);
          }),
          t(r)
  ...
  wn.mixin({
    ...
    resliceDaySegs: function (e, n) {
      ...
      for (i = 0; i < e.length; i++)
        (r = e[i]),
          (s = r.footprint.componentFootprint.unzonedRange.intersect(l)) &&
            u.push(
              t.extend({}, r, {
                footprint: new nn(
                  new We(s, r.footprint.componentFootprint.isAllDay),
  ...
  var Sn = xe.extend({
    ...
    Cn = He.extend({
      ...
      fgSegHtml: function (t, e) {
        ...
        return (
          '<center><a style="text-align:center;" class="' +
          f.join(" ") +
          '"' +
          (u.url ? ' href="' + et(u.url) + '"' : "") +
          (g ? ' style="' + g + '"' : "") +
