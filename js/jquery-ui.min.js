...
(function (t) {
    ...
    (t.widget = function (e, i, s) {
      ...
      return (
        ...
        (a.prototype = t.widget.extend(
          ...
          r,
          { constructor: a, namespace: l, widgetName: e, widgetFullName: h }
        )),
        n
        ...
        (t.fn.position = function (n) {
          ...
          return (
            ...
            this.each(function () {
              ...
              "right" === n.my[0]
                ? (C.left -= h)
                : "center" === n.my[0] && (C.left -= h / 2),
                "bottom" === n.my[1]
                  ? (C.top -= c)
                  : "center" === n.my[1] && (C.top -= c / 2),
                (C.left += M[0]),
                (C.top += M[1]),
                ...
                n.using &&
                  (r = function (t) {
                    ...
                    h > p && p > o(e + i) && (u.horizontal = "center"),
                      c > f && f > o(s + r) && (u.vertical = "middle"),
                      (u.important =
                        a(o(e), o(i)) > a(o(s), o(r))
                          ? "horizontal"
                          : "vertical"),
          ...
          flip: {
            left: function (t, e) {
              var i,
                ...
                f = -2 * e.offset[0];
              0 > c
                ? ((i = t.left + d + p + f + e.collisionWidth - r - a),
                  (0 > i || o(c) > i) && (t.left += d + p + f))
                : u > 0 &&
                  ((s =
                    t.left - e.collisionPosition.marginLeft + d + p + f - l),
                  (s > 0 || u > o(s)) && (t.left += d + p + f));
            },
            top: function (t, e) {
              var i,
                s,
                ...
                g = -2 * e.offset[1];
              0 > c
                ? ((s = t.top + p + f + g + e.collisionHeight - r - a),
                  (0 > s || o(c) > s) && (t.top += p + f + g))
                : u > 0 &&
                  ((i = t.top - e.collisionPosition.marginTop + p + f + g - l),
                  (i > 0 || u > o(i)) && (t.top += p + f + g));
            },
          },
          flipfit: {
            left: function () {
      ...
      switch (s) {
        ...
        case "intersect":
          return (
            ...
            o + e.helperProportions.height / 2 > c &&
      ...
      _mouseStop: function (e) {
        ...
        return (
          this._helper &&
            ...
            h.animate || this.element.css(t.extend(o, { top: l, left: r })),
    ...
    t.ui.plugin.add("resizable", "containment", {
        ...
        d &&
          ...
          /document/.test(u) || u === document
            ...
            : ((e = t(d)),
              ...
              (o = l._hasScroll(d, "left") ? d.scrollWidth : a),
      ...
      resize: function (e) {
        ...
        d[0] !== document && /static/.test(d.css("position")) && (u = l),
          ...
          (i = Math.abs(
            o.sizeDiff.width +
              (o._helper ? o.offset.left - u.left : o.offset.left - l.left)
          )),
          (s = Math.abs(
            o.sizeDiff.height +
              (o._helper ? o.offset.top - u.top : o.offset.top - l.top)
          )),
        ...
        (s.grid = l),
          ...
          /^(se|s|e)$/.test(r)
            ...
            : ((0 >= f - c || 0 >= p - h) &&
              ...
              p - h > 0
                ? ((i.size.width = p), (i.position.left = o.left - u))
                : ((p = h - e.width),
                  (i.size.width = p),
            ...
            this.selectees.each(function () {
              ...
              i &&
                ...
                "touch" === n.tolerance
                  ...
                  : "fit" === n.tolerance &&
                    (h =
                      c.left > a && r > c.right && c.top > o && l > c.bottom),
                h
                  ? (i.selected &&
      ...
      _getItemsAsjQuery: function (e) {
        ...
        if (h && e)
          for (s = h.length - 1; s >= 0; s--)
            for (a = t(h[s], this.document[0]), n = a.length - 1; n >= 0; n--)
      ...
      _eventHandler: function (e) {
        ...
        e.preventDefault(),
          (r && !n.collapsible) ||
            ...
            ((n.active = l ? !1 : this.headers.index(o)),
            (this.active = r ? t() : o),
            this._toggle(u),
            this._removeClass(
              a,
            ...
            r ||
              ...
              n.icons &&
                ((s = o.children(".ui-accordion-header-icon")),
          ...
          e.length
            ? t.length
              ? ((s = t.show().outerHeight()),
                ...
                void 0)
              : e.animate(this.hideProps, a, n, d)
            : t.animate(this.showProps, a, n, d)
        );
      },
        ...
        this._toggleClass(
          ...
          (s = l
            ...
            .each(function () {
              ...
              o._addClass(s, "ui-menu-icon", "ui-icon " + r),
            ...
            : (t.fn[s] &&
                ...
                e.element.find(n).each(function () {
                  ...
                  if ("button" !== s || !n.parent(".ui-spinner").length) {
                    a || (a = n[s]()[s]("instance")),
                      a && (r.classes = e._resolveClassesValues(r.classes, a)),
                      n[s](r);
                    var l = n[s]("widget");
                    t.data(
                      l[0],
        ...
        e.length &&
          (t.each(["first", "last"], function (t, s) {
            ...
            if (n && i["_" + n.widgetName + "Options"]) {
              var a = i["_" + n.widgetName + "Options"](
                1 === e.length ? "only" : s
              );
  ...
  t.extend(s.prototype, {
    ...
    _autoSize: function (t) {
      if (this._get(t, "autoSize") && !t.inline) {
        ...
        o.match(/[DM]/) &&
          ...
          a.setMonth(
            e(this._get(t, o.match(/MM/) ? "monthNames" : "monthNamesShort"))
          ),
          a.setDate(
        ...
        if (b) "'" !== e.charAt(n) || y("'") ? w() : (b = !1);
          ...
          switch (e.charAt(n)) {
            ...
            case "@":
              ...
              break;
            case "!":
              (r = new Date((k("!") - this._ticksTo1970) / 1e4)),
                (g = r.getFullYear()),
                (m = r.getMonth() + 1),
                (_ = r.getDate());
              break;
        ...
        for (w = "", this.maxRows = 4, x = 0; U[1] > x; x++) {
              ...
              switch (x) {
                case 0:
                  (I += " ui-datepicker-group-first"),
                    (M = " ui-corner-" + (j ? "right" : "left"));
                  break;
                case U[1] - 1:
                  (I += " ui-datepicker-group-last"),
                    (M = " ui-corner-" + (j ? "left" : "right"));
                  break;
                default:
          ...
          for (
            I += T + "</tr></thead><tbody>",
              ...
              A = Math.ceil((N + P) / 7),
              O = X ? (this.maxRows > A ? this.maxRows : A) : A,
              this.maxRows = O,
              F = this._daylightSavingAdjust(new Date(te, Z, 1 - N)),
              H = 0;
            O > H;
            H++
          ) {
            for (
              ...
              (E = m ? m.apply(t.input ? t.input[0] : null, [F]) : [!0, ""]),
                (z = F.getMonth() !== Z),
                (Y = (z && !v) || !E[0] || (J && J > F) || (Q && F > Q)),
                (W +=
                  "<td class='" +
                  ...
                  ((F.getTime() === C.getTime() &&
                    Z === t.selectedMonth &&
                    t._keyEvent) ||
                  (b.getTime() === F.getTime() && b.getTime() === C.getTime())
                    ? " " + this._dayOverClass
                    : "") +
                  (Y
                  ...
                  (z && !_
                    ...
                    : "<a class='ui-state-default" +
                      (F.getTime() === R.getTime()
                        ? " ui-state-highlight"
                        : "") +
                      (F.getTime() === G.getTime() ? " ui-state-active" : "") +
    ...
    t.widget("ui.dialog", {
      ...
      _setOption: function (e, i) {
        ...
        "disabled" !== e &&
          ...
          "draggable" === e &&
            ((s = a.is(":data(ui-draggable)")),
            s && !i && a.draggable("destroy"),
            !s && i && this._makeDraggable()),
          "position" === e && this._position(),
          "resizable" === e &&
            ((n = a.is(":data(ui-resizable)")),
            n && !i && a.resizable("destroy"),
    ...
    t.widget("ui.tabs", {
        ...
        (this.tablist = this._getList().attr("role", "tablist")),
          ...
          this.anchors.each(function (i, s) {
            ...
            e._isLocal(s)
              ? ((n = s.hash),
                (o = n.substring(1)),
                (a = e.element.find(e._sanitizeSelector(n))))
              : ((o = l.attr("aria-controls") || t({}).uniqueId()[0].id),
                (n = "#" + o),
                (a = e.element.find(n)),
                a.length ||
                  ((a = e._createPanel(o)),
              ...
              l.attr({ "aria-controls": o, "aria-labelledby": r }),
      ...
      load: function (e, i) {
        ...
        this._isLocal(a[0]) ||
          ((this.xhr = t.ajax(this._ajaxSettings(a, i, r))),
          this.xhr &&
      ...
      _open: function (e, i, s) {
        ...
        if (s) {
          ...
          i.is("[title]") &&
            ...
            this.liveRegion.children().hide(),
            (l = t("<div>").html(o.find(".ui-tooltip-content").html())),
  ...
  t.effects.define("blind", "hide", function (e, i) {
    ...
    (r.clip[s[a][0]] = r.clip[s[a][1]]),
      "show" === e.mode &&
        (n.cssClip(r.clip), l && l.css(t.effects.clipToBox(r)), (r.clip = o)),
    ...
    t.effects.define("clip", "hide", function (e, i) {
      ...
      (s = a.cssClip()),
        ...
        "show" === e.mode && (a.cssClip(n.clip), (n.clip = s)),
        a.animate(n, {
          queue: !1,
          duration: e.duration,
          easing: e.easing,
    ...
    t.effects.define("explode", "hide", function (e, i) {
      ...
      var a,
        ...
        b = [];
      for (a = 0; u > a; a++)
        for (l = m.top + a * v, c = a - (u - 1) / 2, o = 0; d > o; o++)
          (r = m.left + o * _),
            (h = o - (d - 1) / 2),
            p
              .clone()
    ...
    t.effects.define("size", function (e, i) {
      ...
      t.effects.createPlaceholder(o),
        ...
        ("box" === d || "both" === d) &&
          (n.from.y !== n.to.y &&
            ((_ = t.effects.setTransition(o, l, n.from.y, _)),
            (v = t.effects.setTransition(o, l, n.to.y, v))),
          n.from.x !== n.to.x &&
            ((_ = t.effects.setTransition(o, h, n.from.x, _)),
            (v = t.effects.setTransition(o, h, n.to.x, v)))),
        ("content" === d || "both" === d) &&
          n.from.y !== n.to.y &&
          ((_ = t.effects.setTransition(o, r, n.from.y, _)),
          (v = t.effects.setTransition(o, r, n.to.y, v))),
        p &&
        ...
        ("content" === d || "both" === d) &&
          ...
          o.find("*[width]").each(function () {
            ...
            n.from.y !== n.to.y &&
              ((a = t.effects.setTransition(i, l, n.from.y, a)),
              (o = t.effects.setTransition(i, l, n.to.y, o))),
              n.from.x !== n.to.x &&
                ((a = t.effects.setTransition(i, h, n.from.x, a)),
                (o = t.effects.setTransition(i, h, n.to.x, o))),
        ...
        o.animate(v, {
          ...
          complete: function () {
            var e = o.offset();
            0 === v.opacity && o.css("opacity", _.opacity),
              u ||
    ...
    t.effects.define("slide", "show", function (e, i) {
      ...
      t.effects.createPlaceholder(a),
        ...
        "show" === r &&
          (a.cssClip(d.clip), a.css(h, d[h]), (d.clip = s), (d[h] = n)),
        a.animate(d, {
          queue: !1,
          duration: e.duration,
          easing: e.easing,
